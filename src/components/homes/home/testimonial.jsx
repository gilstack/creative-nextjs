...
const Testimonial = () => {
  ...
  return (
    <React.Fragment>
      <div className="tp-testimonial-area black-bg pt-100 pb-100 fix">
        <div className="container-fluid">
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-testimonial-section-box text-center pb-25">
                <h5 className="tp-subtitle">O que dizem sobre nós?</h5>
                <h2 className="tp-title tp-white-text">Feedback</h2>
              </div>
            </div>
          </div>
