...
const creative_contents = {
  ...
  title: (
    <>
      Nossa equipe é especialista em <b>construir</b>, <b>planejar</b> e{" "}
      <b>expandir</b> a visibilidade do seu negócio.
    </>
  ),
  video_id: "PO_fBTkoznc",
  video_title: "Aperte o play e saiba mais sobre como nós fazemos",
  creative_box: [
    {
      id: 1,
      duration: ".3s",
  ...
  return (
    <>
      <div className="p-relative">
        ...
        <div className="tp-creative-area p-relative black-bg cs-border-color pt-100 pb-100 fix">
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="tp-creative-box text-center">
                  ...
                  <div className="tp-play-button mb-110">
                    <button
